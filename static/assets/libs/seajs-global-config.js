...
seajs.config({
    alias: {
        ...
        'video-player-new': __URL_PROTOCOL + ':' + (app.cloudSdkCdn ? app.cloudSdkCdn : '//service-cdn.zhiyun.net') + '/js-sdk/video-player/sdk-v1.js',
        'new-uploader': __URL_PROTOCOL + ':' + (app.cloudSdkCdn ? app.cloudSdkCdn : '//service-cdn.zhiyun.net') + '/js-sdk/uploader/sdk-v1.js',
    ...
    base: app.basePath + '/static/assets/libs',
...
seajs.on('fetch', function(data) {
    ...
    if (/\:\/\/.*?\/static\/assets\/libs\/[^(common)]/.test(data.uri)) {
        return;
    }
